    ...
    <div className="panel">
      ...
      <form onSubmit={handleSubmit}>
        <div className='sectionContainer'>
                <label htmlFor="primjesa-input">Ime poljoprivrednika:</label>
                <input id="primjesa-input" type="text" value={primjesa} onChange={handlePrimjesaChange} />
         </div> 
         <div className='sectionContainer'>
                <label htmlFor="primjesa-input">Prezime poljoprivrednika:</label>
                <input id="primjesa-input" type="text" value={primjesa} onChange={handlePrimjesaChange} />
         </div> 
         <div className='sectionContainer'>
                <label htmlFor="primjesa-input">Adresa poljoprivrednika:</label>
                <input id="primjesa-input" type="text" value={primjesa} onChange={handlePrimjesaChange} />
         </div> 
